...
if __name__ == "__main__":
    ...
    print(
        ...
        "  - /operations/claims        -> queue with flagged/manual/needs-info/"
        "submitted claims + AI review panel\n"
        "  - /operations/benefit-statement -> pick 'Demo Member' -> statement + "
        "utilization panel\n"
        "  - /operations/dependants    -> 'Pending dependant approvals' card "
        "(Demo Junior)\n"
