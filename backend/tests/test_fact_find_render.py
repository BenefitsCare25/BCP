...
from app.services.fact_find_form import BasisRow, SectionContext
from app.services.fact_find_render import _ctext, _fill_basis
...
def test_designation_lands_in_wide_column_not_numbered_cell() -> None:
    ...
    sec = SectionContext(code="GTL", title="GTL", basis_rows=[
...
def test_vertical_merge_writes_one_row_per_category() -> None:
    ...
    sec = SectionContext(code="GCGP_GCSP", title="GCGP", basis_rows=[
