...
from app.services.excel_reader import Cell, Sheet
...
def _cell(rows: Sequence[Sequence[Cell]], row: int, col: int) -> str:
...
def _item_no(rows: Sequence[Sequence[Cell]], row: int) -> str | None:
...
def _content(rows: Sequence[Sequence[Cell]], row: int, text: str) -> str:
